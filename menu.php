...
<div class="row" id="wrap">
    <div class="col-lg-8">
        ...
        <ul id="filter-list" class="clearfix">
            <li>
                <a style="text-decoration: none;" class="filter <?php echo (!isset($_GET['category']) || $_GET['category']=='ALL') ? 'navactive' : '' ?>"  href="<?php echo web_root ?>index.php?view=menu&category=ALL&rem=<?php echo $remarks ?>">Todo</a>
            </li>
            ...
            ?>
            <li >
                <a style="text-decoration: none;"  href="<?php echo web_root; ?>index.php?view=menu&category=<?php echo $result->CATEGORY ?>&rem=<?php echo $remarks ?>" class="filter <?php echo  ($result->CATEGORY==$categ) ?   "navactive" : ""  ?> " ><?php echo $result->CATEGORY; ?></a>
            </li> 
